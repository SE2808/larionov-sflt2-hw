...
```
#### Результат:
1.Балансировка работает корректно с распределением 3:1
2.Отработана отказоустойчивость (при остановке одного сервера трафик идет на второй)
3.Интеграция Nginx → HAProxy функционирует штатно
4.Все конфигурации прошли проверку на корректность
...
HAProxy TCP балансировка (порт 1325): распределение 3:3:3
